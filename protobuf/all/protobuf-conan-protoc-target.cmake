...
if(NOT TARGET protobuf::protoc)
    ...
    ## Last resort: we search in package folder directly
    if(NOT PROTOC_PROGRAM AND NOT CMAKE_CROSSCOMPILING)
        set(PROTOC_PROGRAM "${CMAKE_CURRENT_LIST_DIR}/../../../bin/protoc${CMAKE_EXECUTABLE_SUFFIX}")
    endif()

    # Fail if we did not find protoc
    if(NOT PROTOC_PROGRAM)
        message(FATAL_ERROR "protoc was not found. In cross builds, provide a build-context protobuf/protoc tool.")
    endif()
    get_filename_component(PROTOC_PROGRAM "${PROTOC_PROGRAM}" ABSOLUTE)
