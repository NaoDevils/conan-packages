...
# Licensed under the MIT License.
  ...
  # Jetson / Debian sysroots often place TensorRT headers under include/aarch64-linux-gnu
  find_path(TENSORRT_INCLUDE_DIR NvInfer.h
    HINTS ${TENSORRT_ROOT}
    PATH_SUFFIXES include include/aarch64-linux-gnu)

  if (NOT TENSORRT_INCLUDE_DIR)
    message(FATAL_ERROR "TensorRT headers not found. Looked under ${TENSORRT_ROOT} with suffixes include and include/aarch64-linux-gnu")
  endif()
  ...
  # Jetson / Debian sysroots often place TensorRT libs under lib/aarch64-linux-gnu
