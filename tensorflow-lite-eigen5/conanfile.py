...
class TensorflowLiteConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("ruy/cci.20260211")
    ...
    def _patch_sources(self):
        ...
        # INFO: fix atomic flag (tk 20260307)
        interpreter_h = join(self.source_folder, "tensorflow", "lite", "core", "interpreter.h")
        replace_in_file(self, interpreter_h, "std::atomic_flag continue_invocation_{false};", "std::atomic_flag continue_invocation_{};")        
